  ...
  return (
    <div className="relative z-10">
      <motion.div 
        ...
        className="w-full bg-white rounded-lg overflow-hidden relative p-1"
      >
        {/* Candy Cane Border */}
        <div 
        ...
        <div className="relative bg-white rounded-lg p-8 z-10">
          <h1 className="text-3xl font-festive text-red-600 text-center mb-8">
            My Letter to Santa
          </h1>
            ...
            <div className="overflow-y-auto max-h-[400px]"> {/* Added scrollable container */}
              ...
              <ul className="mt-4 space-y-3">
                {wishes && wishes.length > 0 ? (
                  ...
                  <li className="text-lg text-gray-400">_______</li>
                )}
              </ul>
            </div>
